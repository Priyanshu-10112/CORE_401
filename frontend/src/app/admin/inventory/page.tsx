...
function BulkUploadDialog({ onUploadSuccess }: { onUploadSuccess: () => void }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            // Use the medicine service which includes authentication
            const result = await medicineService.bulkUploadMedicines(selectedFile);
...
export default function InventoryPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingMedicine) {
                await medicineService.updateMedicine(editingMedicine.id.toString(), medicineData);
    ...
    const handleDelete = async (id: string | number, name: string) => {
        ...
        try {
            await medicineService.deleteMedicine(id.toString());
