                ...
                <Card>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="storeAddress" className="text-sm font-semibold text-slate-700">
                                    Store Address *
                                </Label>
                                <div className="relative">
                                    ...
                                    <Textarea
                                        ...
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => handleInputChange('storeAddress', e.target.value)}
                                        placeholder="Complete store address with pincode"
