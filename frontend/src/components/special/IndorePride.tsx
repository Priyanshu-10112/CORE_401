                ...
                <div style={{ transform: "translateZ(75px)", transformStyle: "preserve-3d" }} className="flex flex-col h-full justify-between">
                    <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                            <span className="text-[10px] uppercase font-black tracking-widest text-white/70">Proudly Indori</span>
                            <h3 className="text-white font-black text-xl leading-tight">#1 Cleanest <br />City in India</h3>
                        </div>
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-white/60 text-[10px] font-medium italic">
